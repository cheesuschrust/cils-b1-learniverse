...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0a0a1a] to-[#171730] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className="shadow-xl border-opacity-20 bg-black/40 backdrop-blur-sm border-white/10">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          autoComplete="email"
                          className="bg-black/60 border-white/20 text-white placeholder:text-gray-500"
                          required
                          {...field}
                        />
                      </FormControl>
