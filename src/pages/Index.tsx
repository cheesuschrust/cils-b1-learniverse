  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
              <div className="md:w-1/2 animate-fade-up">
                ...
                <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">
                  ...
                  <div>
                    <span className="text-[#009246]">Daily </span>
                    <span className="text-[#ce2b37]">Practice </span>
                    <span className="text-[#333]">Questions</span>
                  </div>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button asChild variant="outline" className="border-gray-300 px-5 py-2 h-auto hover:bg-gray-50">
              ...
              <div className="md:w-1/2 animate-fade-up" style={{ animationDelay: "200ms" }}>
                <div className="relative transform rotate-2 hover:rotate-0 transition-transform duration-300">
                  <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-all p-6 border border-gray-100">
                    ...
                    <div className="mb-6 text-gray-700 text-lg flex items-center justify-between">
                      <span>Quale di queste città è la capitale d'Italia?</span>
                    ...
                    <div className="space-y-2">
                      <div className="p-3 rounded-md border border-gray-200 hover:border-[#ce2b37] hover:bg-[#ce2b37]/5 cursor-pointer transition-all transform hover:-translate-y-1 hover:shadow-md text-gray-800">
                        Milano
                      </div>
                      <div className="p-3 rounded-md border border-gray-200 hover:border-[#ce2b37] hover:bg-[#ce2b37]/5 cursor-pointer transition-all transform hover:-translate-y-1 hover:shadow-md text-gray-800">
                        Firenze
                      </div>
                      <div className="p-3 rounded-md border border-gray-200 bg-[#F3F9FE] border-[#009246] cursor-pointer transition-all transform hover:-translate-y-1 hover:shadow-md text-gray-800">
                        Roma
                      </div>
                      <div className="p-3 rounded-md border border-gray-200 hover:border-[#ce2b37] hover:bg-[#ce2b37]/5 cursor-pointer transition-all transform hover:-translate-y-1 hover:shadow-md text-gray-800">
                        Venezia
        ...
        <section className="py-16 px-6 md:py-20 bg-gradient-to-r from-[#009246]/5 to-[#ce2b37]/5" id="how-it-works">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 animate-fade-up">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="text-center p-6 rounded-lg border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all animate-fade-up transform hover:-translate-y-1" style={{ animationDelay: `${index * 100}ms` }}>
                  ...
                  <h3 className={`text-xl font-semibold mb-2 ${item.textColor || 'text-gray-800'}`}>{item.title}</h3>
        ...
        {/* CTA Section */}
        <section className="py-16 px-6 bg-gradient-to-r from-[#009246]/20 via-white/80 to-[#ce2b37]/20 md:py-20 border-t border-b border-gray-100">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6 inline-block animate-pulse-soft">
              <span className="inline-block px-4 py-2 rounded-full bg-[#ce2b37]/20 text-[#ce2b37] font-medium text-sm border border-[#ce2b37]/30">Limited Time Offer</span>
            </div>
            <h2 className="text-3xl font-bold mb-4 animate-fade-up">Ready to Start Your Journey?</h2>
            <p className="text-gray-800 mb-8 animate-fade-up" style={{ animationDelay: "100ms" }}>
            ...
            <p className="text-gray-600 text-sm mt-6 animate-fade-up" style={{ animationDelay: "300ms" }}>
...
const FeatureCard = ({ icon, title, description, delay = 0, bgColor = "bg-white", textColor = "text-gray-800", iconBg }: FeatureCardProps) => {
  return (
    <Card className={`border-0 shadow-sm hover:shadow-md transition-all hover:-translate-y-1 cursor-pointer animate-fade-up transform rotate-1 hover:rotate-0 ${bgColor}`} style={{ animationDelay: `${delay}ms` }}>
      <CardContent className="pt-6">
        <div className={`rounded-full ${iconBg || "bg-[#E7F4FD]"} p-4 w-14 h-14 flex items-center justify-center mb-4`}>
          {icon}
        </div>
        <h3 className={`text-xl font-medium mb-2 ${textColor}`}>{title}</h3>
        <p className={bgColor !== "bg-white" ? "text-white/90" : "text-gray-700"}>{description}</p>
      </CardContent>
    </Card>
  );
};
