    ...
    <footer className="bg-gray-50 border-t border-gray-200 py-12 px-6">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-gray-800">Study Tools</h3>
            <ul className="space-y-3">
              <li><Link to="/app/flashcards" className="text-gray-800 hover:text-[#009246] hover:underline transition-colors flex items-center"><span>Flashcards</span></Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/resources/citizenship" className="text-gray-800 hover:text-[#33A5EF] hover:underline transition-colors group flex items-center">
        ...
        <div className="mt-12 pt-6 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-800">© {currentYear} CILS B1 Cittadinanza. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link to="/privacy-policy" className="text-sm text-gray-800 hover:text-[#009246] hover:underline transition-colors">Privacy Policy</Link>
            <Link to="/terms-of-service" className="text-sm text-gray-800 hover:text-[#009246] hover:underline transition-colors">Terms of Service</Link>
            <span className="text-sm text-gray-800 flex items-center">Made with <Heart className="h-3 w-3 mx-1 text-[#ce2b37]" /> in Italy</span>
          </div>
        </div>
      </div>
    </footer>
