    ...
    <footer className="bg-background border-t py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-medium mb-4">Italian Learning</h3>
          ...
          <div>
            <h4 className="text-md font-medium mb-4">Learning</h4>
            <ul className="space-y-2">
              <li><Link to="/flashcards" className="text-muted-foreground hover:text-foreground">Flashcards</Link></li>
              <li><Link to="/practice/reading" className="text-muted-foreground hover:text-foreground">Reading</Link></li>
              <li><Link to="/practice/listening" className="text-muted-foreground hover:text-foreground">Listening</Link></li>
              <li><Link to="/practice/speaking" className="text-muted-foreground hover:text-foreground">Speaking</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © {currentYear} Italian Learning App. All rights reserved.
          </p>
